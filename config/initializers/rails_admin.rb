# RailsAdmin config file. Generated on October 07, 2012 13:33
...
RailsAdmin.config do |config|
  ...
  config.authorize_with do
    store_path()
    redirect_to main_app.signin_path unless current_admin?
  end

  ################  Global configuration  ################

  # Set the admin name here (optional second array element will appear in red). For example:
  config.main_app_name = ['Schedule Gardener', 'Admin']
  ...
  #     configure :house_name, :string
  #     configure :street_number, :string
  #     configure :street_name, :string
  #     configure :address_line_2, :string
  #     configure :town, :string
  #     configure :post_code, :string
  ...
  #   # You can copy this to a 'rails_admin do ... end' block inside your garden.rb model definition
